...
def get_alphabetical_ordering(sample_ids):
    ...
    if np.array_equal(individual_ids[alphabetical_ordering], sorted_individual_ids) is False:
...
clusters_filter_output_dir = sys.argv[3]  # For a jxn to be kept, it must have at least one sample with greater than or equal to min_reads
